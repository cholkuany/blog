        ...
        <div className='prose prose-slate flex flex-col gap-10 sm:max-w-[640px] lg:max-w-[800px] mx-auto'>   
            <div className='prose flex flex-col'>
                <article className='flex flex-col flex-wrap gap-2'>
                    <h1 className={`font-normal text-[1.5em] my-4 tracking-tight text-gray-950 dark:text-gray-950`}>{post.title}</h1>

                    <Author date={post.publishAt.toString()} name={post.authors[0].name}/>

                    <div className={`${richTextStyles} font-normal text-base text-gray-950 dark:text-gray-950 text-left`}>
                        <PortableText
                            value={post.content}
